...
<?php require("partials/banner.php") ?>
    ...
    <main>
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-2xl font-bold mb-6 text-slate-300">Foro de Notas</h1>
            <ul>
                <?php if (isset($notas) && is_array($notas)) : ?>
                    <?php foreach ($notas as $nota) : ?>
                        <li class="mb-6 p-4 bg-slate-200 rounded shadow">
            ...
            <div class="mt-8 ">
                <a href="/notes/create" class="rounded bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-500 hover:scale-105 transition-transform ">Crear nueva nota</a>
            </div>
        </div>
    </main>
